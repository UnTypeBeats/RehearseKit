...
class AudioService:
    ...
    def create_package(self, stems_dir: str, dawproject_path: str, output_path: str):
        """
        ...
        with zipfile.ZipFile(output_path, 'w', zipfile.ZIP_DEFLATED) as zipf:
            ...
            # Add README
            readme = """RehearseKit - Your Complete Rehearsal Toolkit
...
2. *.dawproject - DAW project file (open format)
   - Import into Cubase, Bitwig, PreSonus Studio One
   - Contains all stems with tempo configured
   - Tracks are pre-arranged and color-coded

To use:
- Import the .dawproject file into your DAW
- Or manually import stems from the stems/ folder

Generated by RehearseKit: https://rehearsekit.uk
"""
